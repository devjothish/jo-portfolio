...
const PORTFOLIO_DATA = {
  ...
  certifications: {
    ...
    goldenJacket: {
      ...
      caption: "AWS sends a physical jacket to engineers holding all twelve+ active certifications. Roughly 1,500 holders worldwide.",
      year: 2026,
    ...
    GCP: [
      { name: "Machine Learning Engineer", tier: "professional", suffix: "Professional" },
      { name: "Cloud Architect", tier: "professional", suffix: "Professional" },
      { name: "Data Engineer", tier: "professional", suffix: "Professional" },
      { name: "Cloud Developer", tier: "professional", suffix: "Professional" },
      { name: "DevOps Engineer", tier: "professional", suffix: "Professional" },
      { name: "Database Engineer", tier: "professional", suffix: "Professional" },
      { name: "Cloud Engineer", tier: "associate", suffix: "Associate" },
    ],
  },
